...
public class MaingametwoPlayer extends JFrame implements KeyListener,MouseListener{
    ...
    private int numbericonsanta, numbericongrinch, speed;
    ...
    public MaingametwoPlayer(int numbericonsanta, int numbericongrunch, int speed,String namePlayer1,String namePlayer2,String colorbackground,String colorladder,int sound,int soundeffect) {
        ...
        System.out.println(soundchoose+" "+soundeffectchoose);
